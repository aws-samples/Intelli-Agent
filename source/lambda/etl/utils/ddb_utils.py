...
from constant import KBType, Status, ModelType, IndexTag, IndexType
...
def initiate_index(index_table, group_name, index_id, model_id, index_type, tag, create_time=None, description=""):
    if not create_time:
        create_time = str(datetime.now(timezone.utc))
