...
def intention_detection_lambda(state: ChatbotState):
    ...
    # send trace
    send_trace(
        f"**intention retrieved:**\n{json.dumps(intention_fewshot_examples,ensure_ascii=False,indent=2)}", state["enable_trace"]
    )
