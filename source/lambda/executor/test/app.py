...
with gr.Blocks() as demo:
    ...
    with gr.Tab("Data Process"):
        ...
        with gr.Accordion("ETL API Response", open=False):
            sfn_json = gr.JSON()
        sfn_input = gr.Textbox(label="Step function ARN")
