...
with gr.Blocks() as demo:
    ...
    with gr.Tab("Chat"):
        ...
        gr_answer_output = gr.Text(label="Answer", show_label=True)
        ...
        with gr.Row():
            with gr.Column():
                offline_dropdown = gr.Dropdown(
                    choices=["true", "false"],
                    label="Offline",
                    info="Whether to process the data offline, default is true",
                )
            with gr.Column():
                qa_dropdown = gr.Dropdown(
                    choices=["true", "false"],
                    label="QA Enhancement",
                    info="Whether to enable QA enhancement, after it is enabled, QA pairs will be generated by LLM according to the file content, default is false",
                )
        ...
        with gr.Row():
            ...
            with gr.Column():
                need_split_dropdown = gr.Dropdown(
                    choices=["true", "false"],
                    label="Need split",
                    info="Whether to split the content as chunks, default is false",
                )
