...
const ChatbotDetail: React.FC = () => {
  ...
  const [selectedIndexTypeOption, setSelectedIndexTypeOption] =
    useState<SelectedOption>({ label: 'qq', value: 'qq' });
    ...
    >
      <ContentLayout>
        <SpaceBetween direction="vertical" size="m">
          <Container
            variant="default"
            header={<Header variant="h2">{t('chatbotDetail')}</Header>}
          >
            ...
            <Table
              ...
              filter={
                <TextFilter
                  ...
                  onChange={({ detail }) =>
                    setSearchIndexName(detail.filteringText)
                  }
                />
              }
              pagination={
        ...
        <Modal
          ...
          footer={
            <Box float="right">
              <SpaceBetween direction="horizontal" size="xs">
                <Button variant="link" onClick={() => setAddIndexModel(false)}>
                  {t('button.cancel')}
                </Button>
                <Button variant="primary" onClick={() => saveAddedIndex()}>
                  {t('button.save')}
                </Button>
              </SpaceBetween>
            </Box>
        ...
        >
          <SpaceBetween size={'m'} direction="vertical">
            ...
            <FormField label={t('indexType')} description={t('indexTypeDesc')}>
              <Select
