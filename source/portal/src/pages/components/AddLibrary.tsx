            ...
            >
              <div className="mt-10">
                <FileUpload
                  ...
                  showFileSize
                  accept=".pdf,.csv,.doc,.docx,.html,.json,.txt,.md,.png,.jpg,.jpeg,.webp,.xlsx,.xls,.jsonl"
                  constraintText={`${t('supportFiles')} pdf, csv, docx, html, json, txt, md, png, jpg, jpeg, webp, xlsx, xls, jsonl.`}
                />
              </div>
            </FormField>
            <div>
