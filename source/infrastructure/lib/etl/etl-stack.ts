...
export class EtlStack extends NestedStack {
    ...
    constructor(scope: Construct, id: string, props: ETLStackProps) {
        ...
        const imageUrl = this.account + ".dkr.ecr." + this.region + imageUrlDomain + props.imageName + ":" + props.etlTag;
        ...
        const extraPythonFilesList = [glueLibS3Bucket.s3UrlForObject("llm_bot_dep-0.1.0-py3-none-any.whl")].join(",");
        ...
        const glueJob = new glue.Job(this, "PythonShellJob", {
            ...
            defaultArguments: {
                ...
                "--additional-python-modules": "langchain==0.1.11,beautifulsoup4==4.12.2,requests-aws4auth==1.2.3,boto3==1.28.84,openai==0.28.1,pyOpenSSL==23.3.0,tenacity==8.2.3,markdownify==0.11.6,mammoth==1.6.0,chardet==5.2.0,python-docx==1.1.0,nltk==3.8.1,pdfminer.six==20221105",
        ...
        const lambdaETL = new Function(this,
            ...
            environment: {
                "DEFAULT_EMBEDDING_ENDPOINT": props.embeddingEndpoint[0] || "Default Embedding Endpoint Not Created",
            }
        });
