...
export class EtlStack extends NestedStack {
    ...
    constructor(scope: Construct, id: string, props: etlStackProps) {
        ...
        const imageUrl = '763104351884.dkr.ecr.'+ this.region +'.amazonaws.com/djl-inference:0.21.0-deepspeed0.8.3-cu117'
        const model = new sagemaker.CfnModel(this, 'embedding-model', {
            executionRoleArn: endpointRole.roleArn,
            primaryContainer: {
                image: imageUrl,
                modelDataUrl: `s3://${props._s3ModelAssets}/${props._etlCodePrefix}/etl_model.tar.gz`,
                environment: {
