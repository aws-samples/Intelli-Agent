    ...
    constructor(scope: Construct, id: string, props: etlStackProps) {
        ...
        const glueJob = new glue.Job(this, 'PythonShellJob', {
            ...
            defaultArguments: {
                ...
                '--additional-python-modules': 'langchain==0.0.312,beautifulsoup4==4.12.2,requests-aws4auth==1.2.3,boto3==1.28.84,openai==0.28.1,nougat-ocr==0.1.17,pyOpenSSL==23.3.0,tenacity==8.2.3,markdownify==0.11.6,mammoth==1.6.0,chardet==5.2.0,python-docx==1.1.0',
