  ...
  private createKnowledgeBaseJob(props: any) {
    ...
    const glueJobDefaultArguments: { [key: string]: string } = {
      ...
      "--additional-python-modules":
        "langchain==0.3.19,beautifulsoup4==4.12.2,requests-aws4auth==1.2.3,boto3==1.35.98,openai==1.65.5,pyOpenSSL==23.3.0,tenacity==8.2.3,markdownify==0.11.6,mammoth==1.6.0,chardet==5.2.0,python-docx==1.1.0,pdfminer.six==20221105,smart-open==7.0.4,opensearch-py==2.2.0,lxml==5.2.2,pandas==2.1.2,openpyxl==3.1.5,xlrd==2.0.1,langchain_community==0.3.19,pillow==10.0.1,tiktoken==0.8.0,pypdf==3.17.0",
