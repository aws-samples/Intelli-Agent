...
class TestDocument:
    ...
    def test_01_upload_document_pdf(self):
        '''test case'''
        param = openapi_client.IntellapicogAQLUngsXXVB(content_type='application/pdf', file_name="summary.pdf")
    ...
    def test_02_upload_document_docx(self):
        '''test case'''
        param = openapi_client.IntellapicogAQLUngsXXVB(content_type='application/vnd.openxmlformats-officedocument.wordprocessingml.document', file_name="summary.docx")
        response = self.api_instance.etl_upload_s3_url_post(param)
    ...
    def test_03_upload_document_csv(self):
        '''test case'''
        param = openapi_client.IntellapicogAQLUngsXXVB(content_type='text/csv', file_name="summary.csv")
        response = self.api_instance.etl_upload_s3_url_post(param)
    ...
    def test_04_upload_document_html(self):
        '''test case'''
        param = openapi_client.IntellapicogAQLUngsXXVB(content_type='text/html', file_name="summary.html")
        response = self.api_instance.etl_upload_s3_url_post(param)
    ...
    def test_05_upload_document_jpeg(self):
        '''test case'''
        param = openapi_client.IntellapicogAQLUngsXXVB(content_type='image/jpeg', file_name="summary.jpeg")
        response = self.api_instance.etl_upload_s3_url_post(param)
    ...
    def test_06_upload_document_jpg(self):
        '''test case'''
        param = openapi_client.IntellapicogAQLUngsXXVB(content_type='image/jpeg', file_name="summary.jpg")
        response = self.api_instance.etl_upload_s3_url_post(param)
    ...
    def test_07_upload_document_png(self):
        '''test case'''
        param = openapi_client.IntellapicogAQLUngsXXVB(content_type='image/png', file_name="summary.png")
        response = self.api_instance.etl_upload_s3_url_post(param)
    ...
    def test_08_upload_document_json(self):
        '''test case'''
        param = openapi_client.IntellapicogAQLUngsXXVB(content_type='application/json', file_name="summary.json")
        response = self.api_instance.etl_upload_s3_url_post(param)
    ...
    def test_09_upload_document_md(self):
        '''test case'''
        param = openapi_client.IntellapicogAQLUngsXXVB(content_type='text/markdown', file_name="summary.md")
        response = self.api_instance.etl_upload_s3_url_post(param)
    ...
    def test_10_upload_document_txt(self):
        '''test case'''
        param = openapi_client.IntellapicogAQLUngsXXVB(content_type='text/plain', file_name="summary.txt")
        response = self.api_instance.etl_upload_s3_url_post(param)
    ...
    #     '''test case'''
    #     param = openapi_client.IntellapicogAQLUngsXXVB(content_type='application/jsonlines', file_name="summary.jsonl")
    #     response = self.api_instance.etl_upload_s3_url_post(param)
    ...
    def test_23_delete_document(self):
        '''test case'''
        param = openapi_client.IntellapicoPMQf0Z8Hxy1a(executionId=list(self.exeIdDict.values()))
    ...
    #     '''test case'''
    #     param = openapi_client.IntellapicogAQLUngsXXVB(content_type='application/jsonlines', file_name="summary.pdf")
    #     response = self.api_instance.etl_upload_s3_url_post(param)
