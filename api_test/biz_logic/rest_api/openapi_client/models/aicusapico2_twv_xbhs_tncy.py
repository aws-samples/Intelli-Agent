...
class Aicusapico2TwvXbhsTncy(BaseModel):
    """
    Aicusapico2TwvXbhsTncy
    """ # noqa: E501
    config: Optional[Aicusapico2TwvXbhsTncyConfig] = Field(default=None, alias="Config")
    items: Optional[List[Aicusapico2TwvXbhsTncyItemsInner]] = Field(default=None, alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Items": [Aicusapico2TwvXbhsTncyItemsInner.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
            "Count": obj.get("Count")
        })
        return _obj
