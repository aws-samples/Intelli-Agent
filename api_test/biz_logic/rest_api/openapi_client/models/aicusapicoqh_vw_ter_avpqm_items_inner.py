...
class AicusapicoqhVwTerAVPQmItemsInner(BaseModel):
    """
    AicusapicoqhVwTerAVPQmItemsInner
    """ # noqa: E501
    s3_path: StrictStr = Field(alias="s3Path")
    create_time: StrictStr = Field(alias="createTime")
    s3_prefix: StrictStr = Field(alias="s3Prefix")
    qa_list: Optional[List[AicusapicoqhVwTerAVPQmItemsInnerQAListInner]] = Field(default=None, alias="QAList")
    status: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "QAList": [AicusapicoqhVwTerAVPQmItemsInnerQAListInner.from_dict(_item) for _item in obj["QAList"]] if obj.get("QAList") is not None else None,
