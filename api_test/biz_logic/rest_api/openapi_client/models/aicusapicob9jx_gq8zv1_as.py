...
class Aicusapicob9jxGQ8zv1AS(BaseModel):
    """
    Aicusapicob9jxGQ8zv1AS
    """ # noqa: E501
    config: Optional[Aicusapico2TwvXbhsTncyConfig] = Field(default=None, alias="Config")
    items: Optional[List[Aicusapicob9jxGQ8zv1ASItemsInner]] = Field(default=None, alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Items": [Aicusapicob9jxGQ8zv1ASItemsInner.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
            "Count": obj.get("Count")
        })
        return _obj
