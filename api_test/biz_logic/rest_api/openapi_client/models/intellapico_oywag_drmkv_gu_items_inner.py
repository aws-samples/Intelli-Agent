...
class IntellapicoOYWAgDRMKvGuItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["executionStatus", "s3Prefix", "uiStatus", "s3Bucket", "qaEnhance", "sfnExecutionId", "embeddingModelType", "offline", "executionId", "groupName", "chatbotId", "createTime", "indexId", "operationType"]
