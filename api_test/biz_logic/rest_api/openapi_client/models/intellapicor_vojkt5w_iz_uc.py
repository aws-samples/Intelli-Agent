...
class IntellapicorVOJKT5wIzUC(BaseModel):
    """
    IntellapicorVOJKT5wIzUC
    """ # noqa: E501
    config: Optional[IntellapicorVOJKT5wIzUCConfig] = Field(default=None, alias="Config")
    items: Optional[List[IntellapicorVOJKT5wIzUCItemsInner]] = Field(default=None, alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Config": IntellapicorVOJKT5wIzUCConfig.from_dict(obj["Config"]) if obj.get("Config") is not None else None,
            "Items": [IntellapicorVOJKT5wIzUCItemsInner.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
            "Count": obj.get("Count")
        })
        return _obj
