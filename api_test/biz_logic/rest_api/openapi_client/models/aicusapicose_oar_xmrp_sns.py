...
class AicusapicoseOArXMRpSNs(BaseModel):
    """
    AicusapicoseOArXMRpSNs
    """ # noqa: E501
    offline: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["offline", "chatbotId", "indexType", "operationType", "s3Prefix", "s3Bucket", "qaEnhance"]
