...
class IntellapicowXaFAEWeTgPt(BaseModel):
    """
    IntellapicowXaFAEWeTgPt
    """ # noqa: E501
    items: Optional[List[IntellapicowXaFAEWeTgPtItemsInner]] = Field(default=None, alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [IntellapicowXaFAEWeTgPtItemsInner.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
            "Count": obj.get("Count")
        })
        return _obj
