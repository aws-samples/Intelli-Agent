...
class Aicusapico4rwMspzeBOe5(BaseModel):
    """
    Aicusapico4rwMspzeBOe5
    """ # noqa: E501
    result: Optional[StrictStr] = None
    execution_id: Optional[StrictStr] = None
    input_payload: Optional[Aicusapico4rwMspzeBOe5InputPayload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "input_payload": Aicusapico4rwMspzeBOe5InputPayload.from_dict(obj["input_payload"]) if obj.get("input_payload") is not None else None
        })
        return _obj
