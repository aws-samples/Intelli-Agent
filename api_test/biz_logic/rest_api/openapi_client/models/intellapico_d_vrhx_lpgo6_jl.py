...
class IntellapicoDVrhxLpgo6Jl(BaseModel):
    """
    IntellapicoDVrhxLpgo6Jl
    """ # noqa: E501
    items: Optional[List[IntellapicoDVrhxLpgo6JlItemsInner]] = Field(default=None, alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [IntellapicoDVrhxLpgo6JlItemsInner.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
            "Count": obj.get("Count")
        })
        return _obj
