...
class Aicusapico35klzY80ikPh(BaseModel):
    """
    Aicusapico35klzY80ikPh
    """ # noqa: E501
    items: Optional[List[Aicusapico35klzY80ikPhItemsInner]] = Field(default=None, alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [Aicusapico35klzY80ikPhItemsInner.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
            "Count": obj.get("Count")
        })
        return _obj
