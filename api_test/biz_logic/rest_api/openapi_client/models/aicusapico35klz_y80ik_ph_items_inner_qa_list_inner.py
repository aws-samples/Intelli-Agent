...
class Aicusapico35klzY80ikPhItemsInnerQAListInner(BaseModel):
    """
    Aicusapico35klzY80ikPhItemsInnerQAListInner
    """ # noqa: E501
    question: Optional[StrictStr] = None
    kwargs: Optional[StrictStr] = None
    intention: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["question", "kwargs", "intention"]
