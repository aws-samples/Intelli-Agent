...
class Aicusapico4LPAf103DGIi(BaseModel):
    """
    Aicusapico4LPAf103DGIi
    """ # noqa: E501
    data: Optional[Aicusapico4LPAf103DGIiData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": Aicusapico4LPAf103DGIiData.from_dict(obj["data"]) if obj.get("data") is not None else None,
