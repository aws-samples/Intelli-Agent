...
class AicusapicoHWyvBnB1QggI(BaseModel):
    """
    AicusapicoHWyvBnB1QggI
    """ # noqa: E501
    config: Optional[AicusapicoHWyvBnB1QggIConfig] = Field(default=None, alias="Config")
    items: Optional[List[AicusapicoHWyvBnB1QggIItemsInner]] = Field(default=None, alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Items": [AicusapicoHWyvBnB1QggIItemsInner.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
            "Count": obj.get("Count")
        })
        return _obj
