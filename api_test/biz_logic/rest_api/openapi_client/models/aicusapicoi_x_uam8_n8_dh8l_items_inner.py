...
class AicusapicoiXUam8N8Dh8lItemsInner(BaseModel):
    """
    AicusapicoiXUam8N8Dh8lItemsInner
    """ # noqa: E501
    chatbot_id: StrictStr = Field(alias="ChatbotId")
    model_name: StrictStr = Field(alias="ModelName")
    last_modified_time: StrictStr = Field(alias="LastModifiedTime")
    model_id: StrictStr = Field(alias="ModelId")
    __properties: ClassVar[List[str]] = ["ChatbotId", "ModelName", "LastModifiedTime", "ModelId"]
